...
//
// One local edit since: the central tower. Its top was a single apex point that
// read as a needle, and the neighbouring wall bent halfway down, which made the
// narrow sliver between them look accidental. Two command runs were spliced out
// of the path string and replaced - the wall is now one bowed descent, and the
// top is a flat 25-unit cap with 5-unit rounded corners whose exit tangent
// matches the line that follows, so the shoulder join stays smooth. Everything
// before x=1039 and after x=1083 is byte-identical to what it replaced.
//
