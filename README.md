...
<p align="center">
  <sub><strong>준공 문서 자동화 시작해 프로젝트의 맥락을 파악하는 AI업무공간으로, 더 나아가 건설 AI 업무 인프라를 만들고자 합니다.
</p>
...
건축에서 준공은 모든 문서가 모이는 단계 입니다. AIARC는 준공 문서 업무를 통해 얻은 데이터로 **프로젝트의 맥락을 파악하는 AI 업무공간으로 거듭납니다**

**프로젝트의 맥락을 파악하는 AI 업무공간** AIARC는 어떤 자료가 최신인지, 무엇이 바뀌었는지, 아직 확인할 일이 무엇인지, 그 근거가 어디에 있는지를 함께 파악 합니다.
...
## 다음 제품: AI Project Workspace(AI업무공간)
...
Project State(프로젝트 맥락)의 상세 사례와 제품 원리는 [제품 개요](./docs/PRODUCT_OVERVIEW.md)에서 설명합니다.
