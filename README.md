...
AIARC는 문서·도면·메일·변경 흔적을 연결해 누락과 최신본, 미결사항을 파악하고 다음 업무까지 이어가는 AI 입니다.

건축 도서는 한곳에 있지 않습니다.

도면, HWP, PDF, Excel, 이메일, 사진, BIM, 승인 기록과 변경본, 수정본이 흩어져 있고, 사람이 많은 시간을 써 정리해 왔습니다.
...
> **흩어진 문서와 변경 흔적에서 프로젝트의 상태를 진단하고 재구성하여, 다음 업무를 판단하고 실행하는 AI**
...
- 기존 작업 환경인 Windows 폴더·이메일·HWP 환경을 존중합니다.
