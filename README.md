...
건설 프로젝트의 실제 상태는 한곳에 있지 않습니다.

도면, HWP, PDF, Excel, 이메일, 사진, BIM, 승인 기록과 변경본이 여러 사람과 폴더 사이에 흩어져 있고, 사람은 계속 다음을 기억하고 확인합니다.

- 어떤 자료가 현재 프로젝트에 해당하는가
- 어떤 파일이 최신 유효본인가
...
- 기존 Windows 폴더·이메일·HWP 환경을 존중합니다.
...
모두의 창업 제출 단계에서는 실제 제품으로 이어질 UI/UX와 핵심 업무 흐름을 먼저 시연하고, 이후 실제 현장자료를 이용해 문서 분류, 최신본 후보, 누락·불일치 탐지와 업무시간 절감 효과를 검증합니다.
